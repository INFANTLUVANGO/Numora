...
import { getConnectedInputs } from '../../data/calculatorConnections'
import { getCalculator } from '../../data/calculators'
import { useAppDispatch, useAppSelector } from '../../redux/hooks'
import { consumeHandoff, removeScenario, saveScenario, setHandoff } from '../../redux/calculatorSlice'
import type { CalculatorDefinition, CalculatorMode } from '../../types/calculator'
import { isDefined } from '../../utils/collections'
import { downloadResultPdf } from '../../utils/pdf'

export function CalculatorWorkspace({ calculator }: { calculator: CalculatorDefinition }) {
  ...
  const handleRelated = (targetSlug: string) => {
    const inputs = getConnectedInputs(calculator.slug, targetSlug, result.primary.value, result.breakdown, values)
